...
#ifdef PAMI_2 
    ThisThread::sleep_for(STARTMATCH + 2s);
     start_match = true;
    //printf("Debut du match !\r\n");
    ThisThread::sleep_for(ENDMATCH - STARTMATCH- 2s);
    end_match = true;
#endif

#ifdef PAMI_3 
    ThisThread::sleep_for(STARTMATCH + 3s);
     start_match = true;
    //printf("Debut du match !\r\n");
    ThisThread::sleep_for(ENDMATCH - STARTMATCH - 3s);
    end_match = true;
#endif
...
//Position team bleu
#ifdef PAMI_1 
    Robot.setPosition(2880, 1605, -90, Couleur_Team);
    Robot.Robotgoto(2652, 1605, 170, Couleur_Team, NORMALSPEED);  // Step 1
    Robot.Robotgoto(2897, 809, 0, Couleur_Team, NORMALSPEED);  // Step 2
#endif

#ifdef PAMI_2 
    Robot.setPosition(2880, 1705, -90, Couleur_Team);
    Robot.Robotgoto(2625, 1709, 0, Couleur_Team, NORMALSPEED);  // Step 1
    Robot.Robotgoto(2356, 157, 0, Couleur_Team, NORMALSPEED);  // Step 2
#endif
...
Robot.setPosition(2880, 1805, -90, Couleur_Team);
Robot.Robotgoto(2719, 1804, 0, Couleur_Team, NORMALSPEED);  // Step 1
Robot.Robotgoto(2283, 850, 0, Couleur_Team, NORMALSPEED);  // Step 2
