...
Robot.Robotgoto(458, 1193, 0, Couleur_Team, NORMALSPEED);  // Step 1
Robot.Robotgoto(338, 1193, 0, Couleur_Team, NORMALSPEED);  // Step 2
Robot.Robotgoto(277, 1193, 0, Couleur_Team, NORMALSPEED);  // Step 3
Robot.Robotgoto(354, 800, 0, Couleur_Team, NORMALSPEED);  // Step 4
