...
Robot.setPosition(375, 1775, 0, Couleur_Team);
Robot.Robotgoto(458, 1193, -150, Couleur_Team, NORMALSPEED);  // Step 1
Robot.Robotgoto(338, 1193, -150, Couleur_Team, NORMALSPEED);  // Step 2
Robot.Robotgoto(277, 1193, -150, Couleur_Team, NORMALSPEED);  // Step 3
Robot.Robotgoto(354, 800, -150, Couleur_Team, NORMALSPEED);  // Step 4
Robot.Robotgoto(189, 797, 0, Couleur_Team, NORMALSPEED);  // Step 5
